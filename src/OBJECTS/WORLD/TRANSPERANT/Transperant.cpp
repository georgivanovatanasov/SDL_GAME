...
Transperant::Transperant(std::string name,ShaderManager* SManager,MainMatrix* MMatrix,Sprite* sprite,int start_x,int start_y,short start_w,short start_h,short clip_w,short clip_h): Object(name,SManager,MMatrix,sprite,-32,start_x,start_y,start_w,start_h)
{
    m_cw=clip_w;
    m_ch=clip_h;
